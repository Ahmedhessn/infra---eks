## =========================
## Root stack: live/unified/k8s
## =========================
## WHY: **One EKS cluster** for all logical environments (dev/staging/prod) using Kubernetes namespaces + RBAC.
## WHAT: VPC across **2 AZs** + shared ECR + EKS.
## HOW: Same modules as dev; cluster name is `${var.project}-eks` (no env suffix).
...
resource "aws_security_group" "monitoring" {
  ...
  description = "Allow Grafana/Prometheus access (shared cluster)."
